...
int temp = 0, cnt;
int new_id = 0, ref=0;
String name, title, date, date2, content, passwd;
...
try{
	...
	String sql = "select max(id) as max_id, count(*) as cnt from board_table";
...
sql_update = "insert into board_table values ('" + new_id + "','" + name + "','" + title + "','" + date + "','" + content + "','" + passwd + "')";
...
<a href="board-list.jsp" class="button-list">게시글 목록 보기</a>
</center>
</section>
      	<section>
            <!-- 대충 뭐 요소들이 가득차있음 -->
