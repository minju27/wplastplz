...
<%
	int id;
	String name="", title="", content="", date="", date2="";
	...
	try{
		...
		String sql_update = "update board_table set name = '" + name +  "', title = '" + title + "', date = '" + date + "', content = '" + content + "' where id = " + id;
...
<a href="board-read.jsp?id=<%= request.getParameter("id")%>" class="button">작성한 글 확인</a>

<a href="board-list.jsp" class="button">게시글 목록 보기</a>
</center>
</section>
