            ...
            <div class="container">
                <table class="board-table">
                    <tr>
                            ...
                            <td align="center" bgcolor="silver" width="75" class="th-name">작성자</td>
...
<%
		...
		try{
			...
			sql = "select * from q_a_table order by ref desc, id asc";
...
%>
	<tr>
		...
		<td align="left"><% if(id!=ref)out.println("└→"); %>
			<a href = "Q&A-read.jsp?id=<%= rs.getString("id") %>">
				<%= rs.getString("title") %>
			</a>
		</td>
	...
	%>  <!-- 로그인 된 사람이 보는 화면-->
		<a href="Q&A-insert.jsp" class="btn-write">게시글 쓰기</a>
	<%
		}
	%>
