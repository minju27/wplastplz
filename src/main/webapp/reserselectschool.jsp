...
<body>
    ...
    <main>
     ...
     <center>
     <div class="titleB"style="font-size:40px;padding-bottom:20px;margin-top:150px;"> 
     <hr width="90%">
     예약하고자하는 캠퍼스를 선택해주세요.</div></center>
        <hr width="90%">
        <section class="intro" style="padding-bottom:0;margin-bottom:0;">
