...
<a href="board-modify-pwd.jsp?id=<%=request.getParameter("id") %>" class="button">다시 입력</a>
</center>
<%
...
%>
	...
	<form name="inputForm" action="board-modify-db.jsp" method="post">
	<table border="0">
	...
	<a href = "board-read.jsp?id=<%=request.getParameter("id") %>" class="button-cancel">취소</a>
	</center>
	</section>
