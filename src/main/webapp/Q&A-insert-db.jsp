...
int temp = 0, cnt;
int new_id = 0, ref=0;
String name, title, date, date2, content, passwd, reply;
...
try{
	...
	String sql = "select max(id) as max_id, count(*) as cnt from q_a_table";
...
sql_update = "insert into q_a_table values ('" + new_id + "','" + name + "','" + title + "','" + date + "','" + content + "','" + passwd + "','" + ref + "')";
