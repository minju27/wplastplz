...
try{
	...
	sql1="delete from reser_table where k="+k;
try{
	stmt.executeUpdate(sql1);
}catch(Exception e){
	out.println("DB 연동 오류임니다.:"+e.getMessage());
}%>
<center><h1>예약이 삭제되었습니다.</h1></center>
<HR width="90%">
<div style="text-align:right;margin: 20px 4%;">
<a href="resercheck.jsp"><button>예약 내역 보러가기</button></a>
</div>
      </main> 
