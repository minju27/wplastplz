...
<%
	...
	try{
		...
		String sql_update = "update q_a_table set name = '" + name +  "', title = '" + title + "', date = '" + date + "', content = '" + content + "' where id = " + id;
...
<a href="Q&A-read.jsp?id=<%= request.getParameter("id")%>" class="button">작성한 글 확인</a>
