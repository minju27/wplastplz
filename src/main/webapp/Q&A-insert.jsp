...
%>
	...
	<form name="inputForm" action="Q&A-insert-db.jsp" method="post">
	<table border="0">
		...
		<tr>
			...
			<td><input type="hidden" name="name" value = "<%= userNAME%>"></td>
		</tr>
		<tr>
		<td>&nbsp</td>
		</tr>
	...
	<br>
	<a href = "Q&A-list.jsp" class="button-list"> 게시글 목록 보기</a> <br>
	</center>
	</section>
	        <section>
            <!-- 대충 뭐 요소들이 가득차있음 -->
